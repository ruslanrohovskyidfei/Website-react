        ...
        <h1>Welcome to DFEi Store</h1>
          <div className="wrapper">
              ...
              <div className="content">
                  ...
                  <p>DFEi Store was founded on the belief that everyone deserves to enjoy music in its purest form. We
                      are committed to sourcing headphones from reputable brands known for their superior craftsmanship
                      and audio performance.</p>
                  <p>Explore our website to discover our collection of headphones and accessories designed to enhance
                      your audio journey. If you have any questions or need assistance, don't hesitate to reach out to
